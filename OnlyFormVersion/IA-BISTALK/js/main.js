...
jir.prototype.style = function() {
  ...
  bit.second.CSSText = [HW, ABS].join('') + 'background:url(' + path + 'img/bg-2.png);'
...
'https://www.mobileads.com/api/save_lf?contactEmail=&gotDatas=1&element=[{%22fieldname%22:%22text_1%22,%22value%22:%22name%22},{%22fieldname%22:%22textarea_2%22,%22value%22:%22no%22},{%22fieldname%22:%22text_3%22,%22value%22:%22city%22},{%22fieldname%22:%22text_4%22,%22value%22:%22bday%22},{%22fieldname%22:%22text_5%22,%22value%22:%22email%22}]&user-id=2901&studio-id=280&tab-id=1&trackid=2128&referredURL=http://d2wq251ql2e9x9.cloudfront.net/preview/mobile.html&callback=leadGenCallback&_=1487656474044'
        ...
        if (self.formData.name !== 'n/a' && self.formData.no !== 'n/a' && self.formData.city !== 'n/a') {
          ...
          '&user-id=2901&studio-id=280&tab-id=1&trackid=2128&referredURL=Sample%20Ad%20Unit&callback=leadGenCallback')
        }
